  ...
  panel: {
    bookings: {
      ...
      details: {
        ...
        guestsRooms: '{guests} guests • {rooms} rooms',
      },
      statusModal: {
        title: 'Update Booking Status',
        description: 'Choose the new status for booking {reference}',
        statusLabel: 'Status',
        reasonLabel: 'Reason',
        reasonPlaceholder: 'Add a note for this change',
        reasonRequired: 'Please provide a reason for this update',
        submit: 'Update Status',
        success: 'Booking status updated successfully',
        error: 'Failed to update booking status',
        noAvailableActions: 'No available actions for this booking',
      },
    },
  },
};
